			...
			<div className="relative z-10 max-w-4xl w-full mx-4">
				...
				>
					...
					<div className="font-mono">
						...
						<h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Dhyey Findoriya</h1>
						<p className="text-gray-400 mb-2">Machine Learning Enthusiast</p>
						...
						<div className="flex flex-wrap gap-2 mt-2">
							...
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">LangChain</span>
							...
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">LLM</span>
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">Agent development</span>
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">MCP</span>
						</div>
					</div>
				</motion.div>
			</div>
